...
const EMPTY_FORM = { email: '', name: '', audience: 'employee', gender: 'unknown', dept: '', company: '', lang: '', tags: '', active: true };
...
export default function ContactsPage() {
  ...
  const pageContacts = contacts.slice(pager.page * PAGE_SIZE, pager.page * PAGE_SIZE + PAGE_SIZE);
  const hasMore = (pager.page + 1) * PAGE_SIZE < contacts.length;
        ...
        {canManage && (
          <Card className="editor-card">
            ...
            <form className="login-form" onSubmit={handleSave}>
              ...
              <label><span>Nom</span><input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Test User" /></label>
